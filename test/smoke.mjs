...
check('seven game cards listed', ['NimChick', 'NimStack', 'NimBullseye', 'NimRush', 'NimSwat', 'NimSlice', 'NimDash'].every((n) => document.body.textContent.includes(n)))
...
check('play buttons present (7)', playButtons.length === 7)
