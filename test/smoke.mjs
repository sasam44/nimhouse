...
check('three game cards listed', ['NimChick', 'NimStack', 'NimBullseye'].every((n) => document.body.textContent.includes(n)))
...
check('play buttons present (3)', playButtons.length === 3)
